...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Fine-tuning with LoRA')
    ...
    parser.add_argument('--output_dir', type=str, default='./finetune_results',
                       help='Output directory for results (default: ./finetune_results)')
...
if __name__ == "__main__":
    ...
    training_args = TrainingArguments(
        output_dir=f"{args.output_dir}/{model_short_name}-lora-finetuned-{dataset_params}",
    ...
    # === Step 11: Save ===
    final_model_dir = f"{args.output_dir}/{model_short_name}-finetuned-{dataset_params}"
