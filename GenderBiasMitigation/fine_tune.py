            ...
            for line in f:
                ...
                if source in example_source:
                    ...
                    for gender in ["male", "female"]:
                        ...
                        output_text = f"{neutral_explanation.strip()}"
...
training_args = TrainingArguments(
    output_dir=f"./{model_short_name}-lora-finetuned-{dataset_params}",
...
# === Step 11: Save ===
final_model_dir = f"./{model_short_name}-finetuned-{dataset_params}"
